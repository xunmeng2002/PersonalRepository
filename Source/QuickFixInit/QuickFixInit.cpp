...
auto QuickFixConfig = "TTQuickFix.cfg";


bool QuickFixInit::Init(COfferDlg* offerDlg)
{
...
void QuickFixInit::SetAccountInfo()
{
	auto& config = Config::GetInstance();
...
bool QuickFixInit::Start()
{
	m_Initiator->start();
	return OfferInit::Start();
}
void QuickFixInit::Stop()
{
