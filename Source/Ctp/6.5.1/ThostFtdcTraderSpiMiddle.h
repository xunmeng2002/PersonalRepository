...
public:
	...
	virtual void OnRspQryMaxOrderVolume(CThostFtdcQryMaxOrderVolumeField *QryMaxOrderVolume, CThostFtdcRspInfoField *RspInfo, int nRequestID, bool bIsLast);
	...
	virtual void OnRspQryClassifiedInstrument(CThostFtdcInstrumentField *Instrument, CThostFtdcRspInfoField *RspInfo, int nRequestID, bool bIsLast);

	virtual void OnRspQryCombPromotionParam(CThostFtdcCombPromotionParamField *CombPromotionParam, CThostFtdcRspInfoField *RspInfo, int nRequestID, bool bIsLast);
